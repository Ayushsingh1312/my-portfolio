      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="text-lg text-text-secondary mb-8 leading-relaxed">
            I'm currently open to job opportunities and professional collaborations. Whether you’re a recruiter, hiring manager, or simply want to connect, feel free to reach out. My inbox is always open, and I’ll do my best to respond promptly!
          </p>
          <a
