    ...
    <section id="skills" className="py-20 bg-primary-bg">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-12">
          ...
          {/* Core Competencies */}
          <motion.div variants={skillCategoryVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }}>
            <h3 className="text-2xl font-semibold text-accent-2 mb-6 font-mono text-center sm:text-left">Core Fundamentals</h3>
            <div className="flex flex-wrap justify-center sm:justify-start gap-3">
              {skills.coreFundamentals.map((competency, index) => (
                <motion.span
                  key={index}
                  variants={skillItemVariants}
